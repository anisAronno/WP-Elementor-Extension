...
class Process_Widget extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'process_title',
			[
				'label' => __( 'Process Title', 'atl-extension' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'label_block' => true,
				'placeholder' => __( 'Write Process Title Here', 'atl-extension' ),
			]
        );
		...
		$this->add_control(
			'process_number',
			[
				'label' => __( 'Process Number', 'atl-extension' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
                'label_block' => true,
                'separator'=> 'before',
				'placeholder' => __( 'Write Process Number Here', 'atl-extension' ),
			]
        );
		...
		$this->add_control(
			'process_description',
			[
				'label' => __( 'Process Description', 'atl-extension' ),
