...
class Team_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Atl Team', 'atl-extension' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
                ...
                'label_block' => true,
                'separator'=> 'before',
				'placeholder' => __( 'Choose Team Image', 'atl-extension' ),
			]
        );
		...
		$this->add_control(
			...
			[
                ...
                'label_block' => true,
				'placeholder' => __( 'Write Name Here', 'atl-extension' ),
			]
        );
		...
		$this->add_control(
			...
			[
                ...
                'label_block' => true,
                'separator'=> 'before',
				'placeholder' => __( 'Write Team Here', 'atl-extension' ),
			]
        );
		...
		$this->add_control(
			'show_social_icon',
			[
				'label' => __( 'Show Social Icon?', 'atl-extension' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'atl-extension' ),
				'label_off' => __( 'Hide', 'atl-extension' ),
				'return_value' => 'yes',
				'default' => 'yes',
			]
		);
		...
		$repeater->add_control(
			'team_title', [
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Team Icon Title' , 'atl-extension' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'team_icon',
			[
				'label' => __( 'Team Icon', 'atl-extension' ),
		...
		$repeater->add_control(
			'team_icon_link',
			[
				'label' => __( 'Team Icon Link', 'atl-extension' ),
				'type' => \Elementor\Controls_Manager::URL,
				'placeholder' => __( 'Write Team Icon Link Here', 'atl-extension' ),
			]
        );
		...
		$this->add_control(
			'team_social_list',
			[
				'label' => __( 'Team Social List', 'atl-extension' ),
		...
		$this->add_control(
			'social_heading',
			[
				'label' => __( 'Social Icons', 'atl-extension' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
				'condition' => [
					'show_social_icon' => 'yes'
		...
		$this->add_control(
			'social_size',
			[
				'label' => __( 'Font Size', 'atl-extension' ),
